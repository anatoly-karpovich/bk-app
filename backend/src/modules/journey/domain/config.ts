...
export function getJourneyConfig(rules: JourneyRules = DEFAULT_JOURNEY_RULES): JourneyConfig {
...
export function getNonJackpotPrizes(rules: JourneyRules = DEFAULT_JOURNEY_RULES): number[] {
  return [
    ...new Set(
