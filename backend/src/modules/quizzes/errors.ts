...
export class QuizPlayerAnswerSelectionError extends AppError {
  constructor(reason: "selected_message_required" | "selected_message_forbidden" | "selected_message_wrong_player" | "duplicate_player_selection" | "duplicate_message_selection" | "missing_player_reference" | "duplicate_player_reference") { super("Недопустимый выбор сообщения игрока", { code: "quiz_player_answer_selection_error", statusCode: 400, details: { reason } }); }
}
