...
export const quizzesApi = {
  ...
  addFragment: (projectId: string, eventId: string, questionId: string, mode: "append" | "replace", rawText: string) => apiClient.post<QuizEvent>(`${base(projectId)}/quiz-events/${eventId}/questions/${questionId}/chat-fragments`, { mode, rawText }),
};
